    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 bg-muted flex flex-col items-center justify-center gap-4">
          <div className="mb-6 text-center text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl lg:text-5xl">
          ...
          <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
            <div className="rounded-lg border bg-card p-6 shadow-sm transition-all hover:shadow-md">
              ...
              <p className="text-muted-foreground">
                Vous aurez besoin de vous connecter avec votre compte Discord pour participer.
              </p>
            ...
            <div className="rounded-lg border bg-card p-6 shadow-sm transition-all hover:shadow-md">
              ...
              <p className="text-muted-foreground">Combien de terrains de foot entre Rennes et le Groenland ?</p>
            ...
            <div className="rounded-lg border bg-card p-6 shadow-sm transition-all hover:shadow-md">
              ...
              <p className="text-muted-foreground">
                Bon, y'a pas grand-chose à gagner mais c'est pour le plaisir.
              </p>
            </div>
          </div>
        </section>
      ...
      <footer className="border-t py-6 md:py-0">
        <div className="flex flex-col items-center justify-center gap-4 md:h-24 md:flex-row text-sm text-muted-foreground">
          &copy; {new Date().getFullYear()} KwikKwiz. Tous droits réservés - Créé par KwikKill
